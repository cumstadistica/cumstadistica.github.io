...
- **Notes:**
  ...
  - No pedir comando explícito para subir factos cuando la mención sea clara.
  - Respetar al máximo el texto original del facto; solo corregir lo mínimo o ampliar con imagen/enlace cuando aporte.
  - Mapa de autores: Gonzalo (@gonperezramirez) = `c`, Ugo (@Ugo_Bugo) = `u`, Jose Angel (@Presio6151) = `j`.

## Personas (grupo Cumstadística)

- **@gonperezramirez** — Nombre real: Gonzalo. Alias: C, Cusa, Cusalo.
