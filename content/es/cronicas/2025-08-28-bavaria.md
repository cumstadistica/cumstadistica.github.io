...
{{< figure src="/images/cronicas/hija_del_barquero_1.webp" alt="Hija del Barquero" >}}

{{< figure src="/images/cronicas/hija_del_barquero_2.webp" alt="Hija del Barquero" >}}

J al toque:

{{< figure src="/images/cronicas/tan_buena_no_esta.webp" alt="Tan buena no está" >}}
...
{{< figure src="/images/cronicas/saludo.webp" alt="Saludo" >}}

{{< figure src="/images/cronicas/j-birra.webp" alt="J Birra" >}}
...
{{< figure src="/images/cronicas/marienplatz.webp" alt="Marienplatz" >}}
...
{{< figure src="/images/cronicas/epico.webp" alt="Epico" >}}

## Día 3: Pachaclan

{{< figure src="/images/cronicas/fussen.webp" alt="Füßen" >}}
...
{{< figure src="/images/cronicas/neuschwanstein.webp" alt="Neuschwanstein" >}}
...
{{< figure src="/videos/partnachklamm.mp4" alt="Partnachklamm" >}}

{{< figure src="/images/cronicas/zugspitze.webp" alt="Zugspitze" >}}

## Día 4: Fé ciega

J: Pues fuimos al que es el museo de ciencia y tecnologia más grande del mundo, el Deutsche Museum.

{{< figure src="/images/cronicas/cusa-deutsches-museum.webp" alt="Cusa en el Museo" >}}
...
{{< figure src="/images/cronicas/u-c-deutsches-museum.webp" alt="U C Deutsches Museum" >}}
...
{{< figure src="/videos/fe-ciega-1.mp4" alt="Fé Ciega 1" >}}

{{< figure src="/videos/fe-ciega-2.mp4" alt="Fé Ciega 2" >}}

## Día 5: Stuttgart no es fea (por dónde mea)

{{< figure src="/images/cronicas/angel-caido.webp" alt="Ángel Caído" >}}
...
{{< figure src="/images/cronicas/estatua-viejo.webp" alt="Estatua Viejo" >}}
...
{{< figure src="/images/cronicas/sesa-munich.webp" alt="Sesa Munich" >}}
...
{{< figure src="/images/cronicas/despedida.webp" alt="Despedida Cumstadistica" >}}
