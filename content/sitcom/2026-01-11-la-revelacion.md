...
{{< quote text=`Cusa, tienes esquizofrenia.` author="chat" />}}
...
{{< quote text=`Cusa, eso es una locura, pero también es bastante cierto. Es como si todo esto fuera un bucle infinito: una sitcom de bajo presupuesto en la que cada episodio repite al anterior con cambios mínimos para mantenernos entretenidos, pero sin posibilidad real de avanzar` author="j" />}}
...
{{< quote text=`Emmm, aquí dice que [Dios](/tags/dios) no castiga dos veces… entonces ¿por qué cojones soy feo y enano? No me jodas` author="c" />}}

A esto que sale U de su habitación y suelta:

{{< quote text=`Oye, C, te veo más desquiciado de lo normal. ¿Qué te pasa?` author="u" />}}

C se gira, con mirada de iluminado de gasolinera, y responde:

{{< quote text=`U, me he dado cuenta de que estamos atrapados en un ciclo interminable de eventos repetitivos. Cada día es una variación del anterior. Es como vivir en una simulación.` author="c" />}}

U asiente, tranquilo:

{{< quote text=`Sí, C. Yo eso lo sabía desde hace tiempo, pero tú no te has dado cuenta porque tienes menos memoria que mi tío Eustaquio con alzhéimer.` author="u" />}}

{{< quote text=`¡U, no me jodas! ¿Y por qué no me lo dijiste?` author="c" />}}

{{< quote text=`Te lo dije, C. Lo que pasa es que también se te olvidó.` author="u" />}}
...
{{< quote text=`A ver qué tal esto...` author="c primigenio" />}}

Y metió dos mujerzuelas en la trama para distraerlos:

{{< quote text=`A ver cómo os concentráis con estas dos cachondas llamando a vuestra puerta, jajaja` author="c primigenio" />}}
...
{{< quote text=`U, casi se acaba el día, tenemos que hacer algo.` author="c" />}}

{{< quote text=`¿Terminar el día? Espera… siempre que acaba el episodio, Paco Luque desde el más allá nos deja una moraleja.` author="u" />}}

{{< quote text=`¡Eso es! Hay que encontrar a Paco Luque. Seguro que sabe cómo salir de la sitcom; no por nada es ingeniero agrónomo por la Universidad de Córdoba.` author="c" />}}
...
{{< quote text=`Mira, J, están intentando salir de la sitcom, no son conscientes que sus desventuras son nuestro entretenimiento. Es adorablemente ingenuo.` author="c primigenio" />}}

{{< quote text=`Qué loco, C. ¿Y el minijose?` author="j primigenio" />}}

{{< quote text=`Ni idea. Hace un rato que no aparece.` author="c primigenio" />}}
...
{{< quote text=`UgoBugo, Cusa, ¿qué hacéis por aquí? ¿Cómo habéis encontrado mi casa?` author="paco-luque" />}}

{{< quote text=`Paco, hemos tomado el camino de la licencia artística: hemos venido a buscarte porque creemos que eres el único que puede ayudarnos a salir del bucle.` author="u" />}}

Paco suspiró:

{{< quote text=`Me parece estupendo, pero yo ya estoy jubilado. Ahora me dedico a mi verdadera pasión, al teatro. Ese problema os toca resolverlo a vosotros.` author="paco-luque" />}}
...
{{< quote text=`Madre mía, C… ¿te has fijado? Parece que están dejando de cargar los chunks.` author="u" />}}

Y era verdad. El cielo empezó a volverse negro a cuadritos. Los árboles de la sierra desaparecían por bloques.

{{< quote text=`¿Qué mierda es esto?` author="c" />}}
...
{{< quote text=`¿Madre mía, J, ¿qué está pasando?` author="u" />}}

J se llevaba las manos a la cabeza:

{{< quote text=`Chavales, no vuelvo a jugar al Cities Skylines a máxima resolución en mi puñetera vida…` author="j" />}}
...
{{< quote text=`¡Noooooooo!` author="c" />}}

De vuelta al vacío, C miró a los otros dos, señaló la puerta y dijo:

{{< quote text=`Bueno… el último en cruzarla es maricón, ¿no?` author="c" />}}
